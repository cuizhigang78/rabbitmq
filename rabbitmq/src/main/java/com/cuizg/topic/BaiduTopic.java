...
public class BaiduTopic {
    ...
    public static void main(String[] args) throws IOException {
        ...
        channel.queueDeclare(RabbitConstant.QUEUE_BAIDU_TOPIC, false, false, false, null);

        // queueBind 用于将队列与交换机绑定
        // 参数1：队列名称
        // 参数2：交换机名称
        // 参数3：路由key
        channel.queueBind(RabbitConstant.QUEUE_BAIDU_TOPIC, RabbitConstant.EXCHANGE_WEATHER_TOPIC, "us.#");
        channel.basicQos(1);
        channel.basicConsume(RabbitConstant.QUEUE_BAIDU_TOPIC, false, new DefaultConsumer(channel) {
            @Override
